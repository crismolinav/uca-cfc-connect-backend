...
=======
    ...
    @JoinColumn(name = "id_categoria", nullable = false, foreignKey = @ForeignKey(name = "fk_curso_categoria"))
    private Categoria categoria;
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "id_modalidad", nullable = false, foreignKey = @ForeignKey(name = "fk_curso_modalidad"))
    private Modalidad modalidad;
    @OneToMany(mappedBy = "curso") private List<CursoDocente> docentes = new ArrayList<>();
    @OneToMany(mappedBy = "curso") private List<Actividad> actividades = new ArrayList<>();
    @OneToMany(mappedBy = "curso") private List<DetalleCotizacion> detallesCotizacion = new ArrayList<>();
    @OneToMany(mappedBy = "curso") private List<Inscripcion> inscripciones = new ArrayList<>();
    ...
    public Integer getCupoMaximo() { return cupoMaximo; } public void setCupoMaximo(Integer cupoMaximo) { this.cupoMaximo = cupoMaximo; }
    ...
    public List<CursoDocente> getDocentes() { return docentes; } public void setDocentes(List<CursoDocente> docentes) { this.docentes = docentes; }
